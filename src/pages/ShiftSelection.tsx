  ...
  if (!user.homes || user.homes.length === 0) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-heading-accent mb-4">No Homes Assigned</h2>
        ...
        <CardContent>
          {userShiftsLoading ? (
            ...
            <div className="text-center py-8">
              <CalendarIcon className="h-12 w-12 text-neutral-500 mx-auto mb-4" />
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {userShifts.map((shift) => (
                  <div key={shift.id} className="flex items-center justify-between p-3 bg-neutral-100 dark:bg-neutral-700 rounded-lg">
        ...
        <CardContent>
          {shiftsLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-neutral-950 mb-2">No Available Shifts</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {availableShifts.slice(0, 6).map((shift) => (
                  <div key={shift.id} className="border border-neutral-300 dark:border-neutral-700 rounded-lg p-4 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors">
